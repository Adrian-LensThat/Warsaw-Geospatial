...
namespace Google.XR.ARCoreExtensions.Samples.Geospatial
{
    ...
    public class GeospatialController : MonoBehaviour
    {
        ...
        public GameObject instruction00;
        public GameObject instruction01;
        public GameObject instruction02;
        public GameObject instruction03;
        ...
        public GameObject postcardScreenContainer;
        public GameObject postcardScreenFront;
        public GameObject postcardScreenBack;
        public GameObject postcardWorld;
        private Animator animScreenContainer;
        private Animator animScreenFront;
        private Animator animScreenBack;
        ...
        public void Update()
        {
            ...
            else
            {
                    ...
                    && _anchorObjects.Count < _storageLimit)
                {
                    ...
                    if(tapNum == 1) 
                    {
                        instruction00.SetActive(true);
                    }
                    if(tapNum == 2) 
                    {
                        instruction00.SetActive(false);
                        postcardScreenContainer.SetActive(true);
                        animScreenContainer = postcardScreenContainer.GetComponent<Animator>();
                        animScreenFront = postcardScreenFront.GetComponent<Animator>();
                        animScreenBack = postcardScreenBack.GetComponent<Animator>();
                        animWorld = postcardWorld.GetComponent<Animator>();
                        animWorld.enabled = true;
                        animScreenContainer.enabled = true;
                        StartCoroutine(gorillaWaiter());
                        StartCoroutine(postcardWaiter());
                    }
                    if(tapNum == 3) 
                    {
                    ...
                    if(tapNum == 11) 
                    {
                        info04.SetActive(true);
                    }
                    if(tapNum == 12) 
                    {
                        info04.SetActive(false);
                        info05.SetActive(true);
                    }
                    if(tapNum == 13) 
                    {
        ...
        IEnumerator gorillaWaiter()
    {
        // Wait for 4 seconds
        yield return new WaitForSeconds(3);
        gorilla.SetActive(true);
        light00.SetActive(true);
        light01.SetActive(true);
        light02.SetActive(true);
        light03.SetActive(true);
        light04.SetActive(true);
        light05.SetActive(true);
    }

    IEnumerator postcardWaiter()
    {
        yield return new WaitForSeconds(5);
        animScreenFront.enabled = true;
        yield return new WaitForSeconds(1);
        postcardScreenFront.SetActive(false);
        animScreenBack.enabled = true;
